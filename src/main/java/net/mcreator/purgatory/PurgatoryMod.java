package net.mcreator.purgatory;
...
@Mod("purgatory")
public class PurgatoryMod {
	public static final Logger LOGGER = LogManager.getLogger(PurgatoryMod.class);
	public static final String MODID = "purgatory";

	public PurgatoryMod(IEventBus modEventBus) {
